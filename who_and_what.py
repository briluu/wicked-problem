...
siying = Partner('Li', 'Siying', 'lysialee')
brian = Partner('Luu', 'Brian', 'briluu')
chiho = Partner('Kim', 'Chiho', 'chiho828')

team = [brian, chiho, siying]

problem1 = Problem("Solving nuclear standoff", 'wicked', "Nuclear_Standoff")
 # In this case, the Python file for the formulation would be named End_Poverty.py.

problems = [problem1]

our_submission = Who_and_what([siying, brian, chiho], OPTION_A, problems)
